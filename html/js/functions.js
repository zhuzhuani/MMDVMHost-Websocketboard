...
function getCallsign(logline) {
	...
	if (qrz == 1 && isNaN(callsign) && !qrz_blacklist.includes(callsign)) {
		if (name != "") {
			return '<div class=\"tooltip2\"><a target="_new" href="https://qrz.com/db/' + getNormalizedCallsign(callsign) + '">' + callsign+'('+name +')'+ '</a><span class=\"tooltip2text\">Name:<br>' + name + '</span></div>';
		} else {
